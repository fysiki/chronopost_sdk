...
class ShippingMultiParcelV5 extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\HeaderValueV2|null
     */
    protected ?\StructType\HeaderValueV2 $headerValue = null;
    /**
     * The shipperValue
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \StructType\SkybillWithDimensionsValueV6[]
     */
     ...
     * @param \StructType\HeaderValueV2 $headerValue
     ...
     * @param \StructType\SkybillWithDimensionsValueV6[] $skybillValue
     ...
     * Set esdValue value
     * @param \StructType\EsdValue3 $esdValue
     * @return \StructType\ShippingMultiParcelV5
     */
     ...
     * @return \StructType\HeaderValueV2|null
     */
    public function getHeaderValue(): ?\StructType\HeaderValueV2
    {
     ...
     * @return \StructType\ShippingMultiParcelV5
     */
    public function setHeaderValue(?\StructType\HeaderValueV2 $headerValue = null): self
    {
    ...
    public static function validateShipperValueForArrayConstraintsFromSetShipperValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5ShipperValueItem) {
            ...
            if (!$shippingMultiParcelV5ShipperValueItem instanceof \StructType\ShipperValueV2) {
    ...
    public static function validateRecipientValueForArrayConstraintsFromSetRecipientValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5RecipientValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5RecipientValueItem instanceof \StructType\RecipientValueV2) {
    ...
    public static function validateRefValueForArrayConstraintsFromSetRefValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5RefValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5RefValueItem instanceof \StructType\RefValueV2) {
    ...
    public static function validateSkybillValueForArrayConstraintsFromSetSkybillValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5SkybillValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5SkybillValueItem instanceof \StructType\SkybillWithDimensionsValueV6) {
     ...
     * @throws InvalidArgumentException
     * @param \StructType\SkybillWithDimensionsValueV6 $item
     * @return \StructType\ShippingMultiParcelV5
     */
    public function addToSkybillValue(\StructType\SkybillWithDimensionsValueV6 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\SkybillWithDimensionsValueV6) {
    ...
    public static function validateScheduledValueForArrayConstraintsFromSetScheduledValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5ScheduledValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5ScheduledValueItem instanceof \StructType\ScheduledValue) {
    ...
    public static function validateRecipientLocalValueForArrayConstraintsFromSetRecipientLocalValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5RecipientLocalValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5RecipientLocalValueItem instanceof \StructType\RecipientLocalValueV2) {
    ...
    public static function validateCustomsValueForArrayConstraintsFromSetCustomsValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV5CustomsValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV5CustomsValueItem instanceof \StructType\CustomsValue) {
