...
class ShippingWithReservationAndESDWithRefClient extends AbstractStructBase
{
     ...
     * Set esdValue value
     * @param \StructType\EsdWithRefClientValue $esdValue
     * @return \StructType\ShippingWithReservationAndESDWithRefClient
     */
